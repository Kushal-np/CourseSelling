...
export const signUp = async(req , res) =>{
    ...
    const userSchema = z.object({
        firstName: z.string().min(2,{message:"firstName must be atleast 6 characters long"}),
        lastName:z.string().min(2,{message:"lastName must be atleast 6 characters long"}),
